...
public final class EncryptRSA {
	...
	public static String loadPublicKeyByFile() throws Exception {
		try {
			InputStream in = EncryptRSA.class.getClassLoader().getResourceAsStream("publicKey.keystore");
	...
	public static String loadPrivateKeyByFile() throws Exception {
		try {
			InputStream in = EncryptRSA.class.getClassLoader().getResourceAsStream("privateKey.keystore");
			BufferedReader br = new BufferedReader(new InputStreamReader(in));
			String readLine = null;
			StringBuilder sb = new StringBuilder();
			while ((readLine = br.readLine()) != null) {
